  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center w-full min-h-screen bg-gradient-to-br from-red-100 to-red-200 px-4">
        <div
          className={`bg-white shadow-lg rounded-lg p-10 w-full max-w-md transform transition-all duration-500 ${show ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
        >
